...
class EccubeDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'security.request_matcher.vtfjhy8' => 'getSecurity_RequestMatcher_Vtfjhy8Service.php',
        ...
        $this->privates = [
            ...
            'security.request_matcher.vtfjhy8' => true,
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \Plugin\CustomerRank\Doctrine\EventSubscriber\CustomerPriceEventSubscriber());
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => ($this->targetDirs[3].'/app/Plugin/CustomerRank/Entity')]);
        ...
        $b->addDriver($e, 'Plugin\\CustomerRank\\Entity');
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.vtfjhy8']) ? $this->services['security.request_matcher.vtfjhy8'] : ($this->services['security.request_matcher.vtfjhy8'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
    ...
    protected function getValidator_BuilderService()
    {
        ...
        }, 'Plugin\\CustomerRank\\Form\\Validator\\DuplicateSalonCodeValidator' => function () {
            return ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Validator\\DuplicateSalonCodeValidator']) ? $this->services['Plugin\\CustomerRank\\Form\\Validator\\DuplicateSalonCodeValidator'] : $this->load('getDuplicateSalonCodeValidatorService.php')) && false ?: '_'};

...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['Eccube\\Form\\Type\\AddCartType' => function () {
...
}, 'Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerSalonCodeType' => function () {
    return ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerSalonCodeType']) ? $this->services['Plugin\\CustomerRank\\Form\\Type\\Admin\\CustomerSalonCodeType'] : $this->load('getCustomerSalonCodeTypeService.php')) && false ?: '_'};
...
}, 8), 'Eccube\\Form\\Type\\Admin\\CustomerType' => new RewindableGenerator(function () {
    ...
    yield 0 => ${($_ = isset($this->services['Plugin\\CustomerRank\\Form\\Extension\\EntryExtension']) ? $this->services['Plugin\\CustomerRank\\Form\\Extension\\EntryExtension'] : $this->load('getEntryExtensionService.php')) && false ?: '_'};

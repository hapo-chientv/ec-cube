 ...
 */
class EccubeProProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/eccube')) {
            // admin_login
            if ('/eccube/login' === $pathinfo) {
            ...
            if (0 === strpos($pathinfo, '/eccube/s')) {
                // admin_homepage_sale
                if ('/eccube/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/eccube/se')) {
                    // admin_homepage_nonstock
                    if ('/eccube/search_nonstock' === $pathinfo) {
                    ...
                    if ('/eccube/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/setting')) {
                        if (0 === strpos($pathinfo, '/eccube/setting/shop')) {
                            // admin_setting_shop_csv
                            if (0 === strpos($pathinfo, '/eccube/setting/shop/csv') && preg_match('#^/eccube/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                            ...
                            if (0 === strpos($pathinfo, '/eccube/setting/shop/delivery')) {
                                // admin_setting_shop_delivery
                                if ('/eccube/setting/shop/delivery' === $pathinfo) {
                                ...
                                if ('/eccube/setting/shop/delivery/new' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                                ...
                                if ('/eccube/setting/shop/delivery/sort_no/move' === $pathinfo) {
                            ...
                            elseif (0 === strpos($pathinfo, '/eccube/setting/shop/mail')) {
                                // admin_setting_shop_mail
                                if ('/eccube/setting/shop/mail' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                                ...
                                if ('/eccube/setting/shop/mail/preview' === $pathinfo) {
                            ...
                            elseif (0 === strpos($pathinfo, '/eccube/setting/shop/payment')) {
                                // admin_setting_shop_payment
                                if ('/eccube/setting/shop/payment' === $pathinfo) {
                                ...
                                if ('/eccube/setting/shop/payment/new' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                                ...
                                if ('/eccube/setting/shop/payment/image/add' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                                ...
                                if ('/eccube/setting/shop/payment/sort_no/move' === $pathinfo) {
                            ...
                            // admin_setting_shop
                            if ('/eccube/setting/shop' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/eccube/setting/shop/tax')) {
                                // admin_setting_shop_tax
                                if ('/eccube/setting/shop/tax' === $pathinfo) {
                                ...
                                if ('/eccube/setting/shop/tax/new' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        elseif (0 === strpos($pathinfo, '/eccube/setting/system')) {
                            // admin_setting_system_authority
                            if ('/eccube/setting/system/authority' === $pathinfo) {
                            ...
                            if ('/eccube/setting/system/log' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/eccube/setting/system/masterdata')) {
                                // admin_setting_system_masterdata
                                if ('/eccube/setting/system/masterdata' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                                ...
                                if ('/eccube/setting/system/masterdata/edit' === $pathinfo) {
                            ...
                            elseif (0 === strpos($pathinfo, '/eccube/setting/system/member')) {
                                // admin_setting_system_member
                                if ('/eccube/setting/system/member' === $pathinfo) {
                                ...
                                if ('/eccube/setting/system/member/new' === $pathinfo) {
                                ...
                                if (preg_match('#^/eccube/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                                ...
                                if (preg_match('#^/eccube/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                                ...
                                if (preg_match('#^/eccube/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                                ...
                                if (preg_match('#^/eccube/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/eccube/setting/system/security' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/eccube/setting/system/system')) {
                                // admin_setting_system_system
                                if ('/eccube/setting/system/system' === $pathinfo) {
                                ...
                                if ('/eccube/setting/system/system/phpinfo' === $pathinfo) {
                        ...
                        if ('/eccube/setting/customer_rank' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/eccube/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/eccube/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/eccube/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/shipping/preview_notify_mail') && preg_match('#^/eccube/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/shipping/notify_mail') && preg_match('#^/eccube/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/eccube/store/plugin')) {
                    if (0 === strpos($pathinfo, '/eccube/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/eccube/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/eccube/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/eccube/store/plugin/api/search/page') && preg_match('#^/eccube/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/eccube/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/eccube/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/store/plugin/api/delete') && preg_match('#^/eccube/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/eccube/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/eccube/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/eccube/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/eccube/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/eccube/store/plugin/authentication_setting' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/eccube/store/template')) {
                    // admin_store_template
                    if ('/eccube/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/eccube/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/eccube/c')) {
                // admin_change_password
                if ('/eccube/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/eccube/content')) {
                    if (0 === strpos($pathinfo, '/eccube/content/block')) {
                        // admin_content_block
                        if ('/eccube/content/block' === $pathinfo) {
                        ...
                        if ('/eccube/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/eccube/content/c')) {
                        // admin_content_cache
                        if ('/eccube/content/cache' === $pathinfo) {
                        ...
                        // admin_content_css
                        if ('/eccube/content/css' === $pathinfo) {
                        ...
                        if ('/eccube/content/customer_rank/list' === $pathinfo) {
                        ...
                        if ('/eccube/content/customer_rank/detail' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/eccube/content/file_')) {
                        // admin_content_file
                        if ('/eccube/content/file_manager' === $pathinfo) {
                        ...
                        if ('/eccube/content/file_view' === $pathinfo) {
                        ...
                        if ('/eccube/content/file_delete' === $pathinfo) {
                        ...
                        if ('/eccube/content/file_download' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/content/layout')) {
                        // admin_content_layout
                        if ('/eccube/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/content/news')) {
                        // admin_content_news
                        if ('/eccube/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/content/news/page') && preg_match('#^/eccube/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/eccube/content/page')) {
                        // admin_content_page
                        if ('/eccube/content/page' === $pathinfo) {
                        ...
                        if ('/eccube/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/eccube/customer')) {
                    // admin_customer
                    if ('/eccube/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/eccube/customer/page') && preg_match('#^/eccube/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/eccube/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/eccube/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/eccube/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/customer/customer_rank_csv_upload' === $pathinfo) {
                    ...
                    if ('/eccube/customer/customer_rank_csv_template' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/customer/rank')) {
                        // admin_customer_rank
                        if ('/eccube/customer/rank' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/customer/rank/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/customer/rank/priority/move' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/customer/rank/edit')) {
                            // admin_customer_rank_new
                            if ('/eccube/customer/rank/edit' === $pathinfo) {
                            ...
                            if (preg_match('#^/eccube/customer/rank/edit(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/eccube/customer/salon-code')) {
                        // admin_customer_salon_code
                        if ('/eccube/customer/salon-code' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\CustomerRank\\Controller\\Admin\\CustomerSalonCodeEditController::index',  '_route' => 'admin_customer_salon_code',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_admin_customer_salon_code;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'admin_customer_salon_code', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_admin_customer_salon_code:

                        // admin_customer_salo_code_move
                        if ('/eccube/customer/salon-code/priority/move' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\CustomerRank\\Controller\\Admin\\CustomerSalonCodeEditController::movePriority',  '_route' => 'admin_customer_salo_code_move',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($canonicalMethod, ['POST', 'GET'])) {
                                if ($hasRequiredScheme) {
                                ...
                                goto not_admin_customer_salo_code_move;
                            }
                            if (!$hasRequiredScheme) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_admin_customer_salo_code_move;
                                ...
                                return array_replace($ret, $this->redirect($rawPathinfo, 'admin_customer_salo_code_move', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_admin_customer_salo_code_move:

                        // admin_customer_salon_code_delete
                        if (preg_match('#^/eccube/customer/salon\\-code/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_customer_salon_code_delete']), array (  '_controller' => 'Plugin\\CustomerRank\\Controller\\Admin\\CustomerSalonCodeEditController::delete',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, ['DELETE'])) {
                                if ($hasRequiredScheme) {
                                ...
                                goto not_admin_customer_salon_code_delete;
                            }
                            if (!$hasRequiredScheme) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_admin_customer_salon_code_delete;
                                ...
                                return array_replace($ret, $this->redirect($rawPathinfo, 'admin_customer_salon_code_delete', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_admin_customer_salon_code_delete:

                        // admin_customer_salon_code_new
                        if ('/eccube/customer/salon-code/new' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\CustomerRank\\Controller\\Admin\\CustomerSalonCodeEditController::create',  '_route' => 'admin_customer_salon_code_new',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_admin_customer_salon_code_new;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'admin_customer_salon_code_new', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_admin_customer_salon_code_new:

                        // admin_customer_salon_code_update
                        if (0 === strpos($pathinfo, '/eccube/customer/salon-code/update') && preg_match('#^/eccube/customer/salon\\-code/update(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                            $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'admin_customer_salon_code_update']), array (  'id' => NULL,  '_controller' => 'Plugin\\CustomerRank\\Controller\\Admin\\CustomerSalonCodeEditController::update',));
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, ['POST'])) {
                                if ($hasRequiredScheme) {
                                ...
                                goto not_admin_customer_salon_code_update;
                            }
                            if (!$hasRequiredScheme) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_admin_customer_salon_code_update;
                                ...
                                return array_replace($ret, $this->redirect($rawPathinfo, 'admin_customer_salon_code_update', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_admin_customer_salon_code_update:
            ...
            elseif (0 === strpos($pathinfo, '/eccube/order')) {
                // admin_shipping_csv_import
                if ('/eccube/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/eccube/order/csv_template' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/eccube/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/eccube/order/search')) {
                    if (0 === strpos($pathinfo, '/eccube/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/eccube/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/order/search/customer/html/page') && preg_match('#^/eccube/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/order/search/product')) {
                        // admin_order_search_product
                        if ('/eccube/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/eccube/order/search/product/page') && preg_match('#^/eccube/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/eccube/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/eccube/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/eccube/order/page') && preg_match('#^/eccube/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/eccube/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/eccube/order/export')) {
                    // admin_order_export_order
                    if ('/eccube/order/export/order' === $pathinfo) {
                    ...
                    if ('/eccube/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/eccube/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/eccube/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/eccube/product')) {
                if (0 === strpos($pathinfo, '/eccube/product/c')) {
                    if (0 === strpos($pathinfo, '/eccube/product/category')) {
                        // admin_product_category
                        if ('/eccube/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/eccube/product/category/export' === $pathinfo) {
                        ...
                        if ('/eccube/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/eccube/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/eccube/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/eccube/product/class_name')) {
                        // admin_product_class_name
                        if ('/eccube/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/eccube/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/eccube/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/eccube/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/eccube/product/csv_template') && preg_match('#^/eccube/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/eccube/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/eccube/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/eccube/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/eccube/product/page') && preg_match('#^/eccube/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/eccube/product/product')) {
                    // admin_product_image_add
                    if ('/eccube/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/eccube/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/eccube/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/eccube/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/eccube/product/classes') && preg_match('#^/eccube/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/eccube/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/eccube/product/bulk/product-status') && preg_match('#^/eccube/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/eccube/product/tag')) {
                    // admin_product_tag
                    if ('/eccube/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/eccube/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/eccube/product/tag/sort_no/move' === $pathinfo) {
        ...
        elseif (0 === strpos($pathinfo, '/entry')) {
            ...
            // entry
            if ('/entry' === $pathinfo) {
                $ret = array (  '_controller' => 'Plugin\\CustomerRank\\Controller\\EntryCodeController::index',  '_route' => 'entry',);
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_entry;
        ...
        elseif (0 === strpos($pathinfo, '/block')) {
            ...
            // block_qr_code
            if (0 === strpos($pathinfo, '/block/qr-code') && preg_match('#^/block/qr\\-code(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                $ret = $this->mergeDefaults(array_replace($matches, ['_route' => 'block_qr_code']), array (  'id' => NULL,  '_controller' => 'Plugin\\CustomerRank\\Controller\\Block\\CustomerShowQrController::index',));
                $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                if (!isset($requiredSchemes[$context->getScheme()])) {
                    if ('GET' !== $canonicalMethod) {
                        goto not_block_qr_code;
                    }

                    return array_replace($ret, $this->redirect($rawPathinfo, 'block_qr_code', key($requiredSchemes)));
                }

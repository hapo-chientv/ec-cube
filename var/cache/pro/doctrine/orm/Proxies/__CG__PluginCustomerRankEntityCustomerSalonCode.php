 ...
 */
class CustomerSalonCode extends \Plugin\CustomerRank\Entity\CustomerSalonCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'id', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'salon_code', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'priority', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'status', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'create_date', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'update_date', '' . "\0" . 'Plugin\\CustomerRank\\Entity\\CustomerSalonCode' . "\0" . 'Member'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerSalonCode $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSalonCode($salonCode)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSalonCode', [$salonCode]);

        return parent::setSalonCode($salonCode);
    }
    ...
    public function getSalonCode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSalonCode', []);

        return parent::getSalonCode();
    }
